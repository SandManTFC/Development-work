...
<?php
class Help_form extends CI_Controller{
	...
	function index()
	{
		...
		public function SendHelpMessage()
		{
			...
			$mail->FromName = "PDL paving and groundworks";
			...
			$mail->Subject = "Contact Message from PDL!";
			
	
	
	
	$mail->Body = "You have a Contact message from PDL paving and groundworks: {$_POST['message']}. Reply to {$_POST['email']}"; //HTMl Body
	...
	echo "Mailer Error: " . $mail->ErrorInfo;
		...
		{
	    echo "Email Sent, Thank you for your enquire, We will contact you soon.";
